...
class SocialHandler(object):
    ...
    @abc.abstractmethod
    def write(self,message=u''):
        """ This method posts a message to a social network """

    def append_message(self, message=u''):
    ...
    def changeLinksToURLs(self, msg=u''):
    ...
    def HTMLConvert(self, msg=u'' ):
        ...
        txt = subprocess.check_output('/usr/bin/lynx --dump -width 2048 -nolist /tmp/%d_msg.html' % (pid), stderr=subprocess.STDOUT, shell=True)
